	...
	<div class="container">
		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<ul class="navbar-nav m-auto">
				...
				<li class="nav-item"><a class="nav-link" href="category.html">Sản
						phẩm</a></li>
				<li class="nav-item"><a class="nav-link" href="product.html">Màn
						hình</a></li>
				<li class="nav-item"><a class="nav-link" href="contact.html">CPU</a>
				</li>
