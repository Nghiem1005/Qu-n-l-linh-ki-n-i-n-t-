        ...
        <div class="col-12 col-sm-3">
            <div class="card bg-light mb-3">
                ...
                <ul class="list-group category_block">
                    <li class="list-group-item"><a href="category.html">Bàn phím</a></li>
                    <li class="list-group-item"><a href="category.html">Bo mạch chủ</a></li>
                    <li class="list-group-item"><a href="category.html">Card đồ họa</a></li>
                    <li class="list-group-item"><a href="category.html">Chuột</a></li>
                    <li class="list-group-item"><a href="category.html">CPU</a></li>
                </ul>
            </div>
            <div class="card bg-light mb-3">
